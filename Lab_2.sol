...
contract Wallet{  
    ...
    // Мапа для хранения информации о транзакциях
    mapping(address => DepositEvent) public DepositMap;
    ...
    function Deposit() public payable {  
        ...
        // Добавление информации о транзакции в мапу
       DepositMap[msg.sender] = DepositEvent(block.timestamp, msg.value);
    }  
